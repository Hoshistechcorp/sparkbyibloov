...
const programs = [
  { id: '1', coolName: 'The Architect', realName: 'Advanced Event Planning & Creative Organizing', tag: 'FLAGSHIP', desc: 'Go beyond logistics — master strategic budgeting, risk management, and immersive concept development that transforms ordinary events into extraordinary, high-impact experiences.', duration: '12 weeks', lessons: 36, color: '#65A300', image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=600&h=400&fit=crop' },
  ...
  { id: '3', coolName: 'The Alchemist', realName: 'Professional Mixology & Bartending', tag: 'CORE', desc: 'In-depth training in cocktail crafting, bar management, and customer engagement in hospitality settings.', duration: '10 weeks', lessons: 30, color: '#FF6B35', image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=600&h=400&fit=crop' },
  { id: '4', coolName: 'The Gatekeeper', realName: 'Concierge & Waitstaff Excellence', tag: 'ESSENTIAL', desc: 'Professional etiquette, crowd management, crisis handling, and service techniques for events, conferences, and hospitality settings.', duration: '6 weeks', lessons: 18, color: '#00C896', image: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop' },
  { id: '5', coolName: 'The Voice', realName: 'Orators — MC Bootcamp', tag: 'SIGNATURE', desc: 'Stage command, audience engagement, improvisation, microphone techniques, and crowd control.', duration: '8 weeks', lessons: 24, color: '#FF3366', image: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=600&h=400&fit=crop' },
  { id: '6', coolName: 'The Narrator', realName: 'Storyteller — TikTok Content for Events', tag: 'TRENDING', desc: 'Create compelling short-form videos for events, venues, and hospitality brands. Storytelling, editing, trends, and monetization.', duration: '6 weeks', lessons: 20, color: '#CCFF00', image: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=600&h=400&fit=crop' },
  { id: '7', coolName: 'The Lens', realName: 'Visual Storytelling — Photo & Video', tag: 'CREATIVE', desc: 'Photography and videography for compelling narratives. Composition, lighting, editing, and portfolio development.', duration: '10 weeks', lessons: 32, color: '#7B61FF', image: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=600&h=400&fit=crop' },
  { id: '8', coolName: 'The Selector', realName: 'DJ Arts & Music Industry', tag: 'SIGNATURE', desc: 'Mixing, scratching, beat-matching, set curation, music theory, audio engineering, and the business side of the music industry.', duration: '12 weeks', lessons: 36, color: '#FF6B35', image: 'https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=600&h=400&fit=crop' },
];
        ...
        <section className="px-4 md:px-12 pb-16 md:pb-24 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {programs.map((p) => (
              <div
                key={p.id}
                className="group relative rounded-2xl md:rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:shadow-2xl"
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-end p-5 md:p-8" style={{ minHeight: '280px' }}>
                  ...
                  <div className={`flex gap-2 md:gap-3 mt-3 md:mt-4 transition-all duration-500 md:${hoveredId === p.id ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                    <button className="text-[10px] tracking-[0.12em] uppercase font-extrabold px-4 md:px-5 py-2 md:py-2.5 rounded-full transition-colors" style={{ backgroundColor: p.color, color: p.color === '#CCFF00' ? '#1a1a1a' : '#fff' }}>
                      Enroll Now
                    </button>
