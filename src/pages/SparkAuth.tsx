...
const SparkAuth = () => {
  ...
  return (
    <>
      <SEOHead
        title={isSignUp ? 'Join Spark — Start Learning' : 'Sign In — Spark'}
        description="Join Spark by iBloov Learning. Access micro-credentials in hospitality, events & tourism."
      />
          ...
          >
              ...
              {isSignUp && (
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-gray-900 focus:border-[#CCFF00] focus:outline-none transition-colors"
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <button
                ...
                className="text-[#65A300] font-bold hover:underline"
              >
