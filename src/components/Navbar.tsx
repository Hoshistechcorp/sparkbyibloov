        ...
        <div className="hidden md:flex items-center">
          {navLinks.map((link, i) => (
            <Link
              key={link.to}
              to={link.to}
              className={`relative overflow-hidden bg-white text-black h-[34px] px-3 flex items-center text-[11px] font-medium uppercase border border-black leading-none group ${i > 0 ? 'border-l-0' : ''}`}
            >
