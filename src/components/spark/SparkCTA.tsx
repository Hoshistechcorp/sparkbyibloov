...
import { SparkReferDialog } from './SparkReferDialog';
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="border-2 border-gray-200 text-gray-600 font-bold text-sm tracking-[0.08em] uppercase px-10 py-4 rounded-full hover:bg-gray-50 transition-all flex items-center gap-2"
          >
